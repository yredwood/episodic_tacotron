...
#                drop_last=True, collate_fn=collate_fn)
        ...
        train_loader = DataLoader(trainset, num_workers=1, batch_sampler=train_sampler, pin_memory=False,
                collate_fn=collate_fn)
        val_loader = DataLoader(valset, num_workers=1, batch_sampler=val_sampler, pin_memory=False,
                collate_fn=collate_fn)
...
def validate(model, val_sampler, val_loader, criterion, iteration, n_gpus,
...
#                                pin_memory=False, collate_fn=collate_fn)
        ...
        for i, batch in enumerate(val_loader):
            ...
            #print (x['query']['speaker_ids']) # debug ## 
            y_pred = model(x)
...
#                        hparams.distributed_run, rank)
                validate(model, val_sampler, val_loader, criterion, iteration, n_gpus,
